...
_C.MODEL.ROI_RELATION_HEAD.USE_VLTRANSE = False
...
# BERT Params (for VLTransE)
_C.MODEL.ROI_RELATION_HEAD.BERT_CONFIG_PATH = 'sgg_configs/bert/bert_config.json'

# VLTransE Params
_C.MODEL.ROI_RELATION_HEAD.VLTRANSE = CN()
_C.MODEL.ROI_RELATION_HEAD.VLTRANSE.CLASSES_FN = 'visualgenome/VG-SGG-dicts-danfeiX-overlap.json'
